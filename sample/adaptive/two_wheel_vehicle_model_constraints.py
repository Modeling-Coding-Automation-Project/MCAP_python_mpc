...
system for a two-wheel vehicle model with input constraints.
...
where the MPC tracks a reference trajectory for vehicle position, heading (theta),
yaw rate (r), and speed (V) while respecting steering (delta) and acceleration limits.
