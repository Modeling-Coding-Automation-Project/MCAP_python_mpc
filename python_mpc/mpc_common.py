...
def initialize_kalman_filter_with_EKF(
    ...
    This method generates Python code for the state and measurement equations (and their Jacobians)
    ...
    Args:
        ...
        hx_jacobian (sp.Matrix): Jacobian of the measurement equation with respect to X.
    ...
    Returns:
        tuple: (
            ...
            fxu_file_name (str): Filename of the generated state equation script,
            fxu_jacobian_X_file_name (str): Filename of the generated state equation Jacobian script,
            hx_file_name (str): Filename of the generated measurement equation script,
            hx_jacobian_file_name (str): Filename of the generated measurement equation Jacobian script
    """
